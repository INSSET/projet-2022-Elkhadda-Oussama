 ...
 */
class CommercantRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(Commercant $entity, bool $flush = false): void
    {
    ...
    public function remove(Commercant $entity, bool $flush = false): void
    {
